            ...
            !wallet
              ?(
                <div className='col-10 col-sm-8 col-lg-6'>
                  <img alt='Crypto Campaigns' src='https://cdn.pixabay.com/photo/2020/11/06/19/12/kid-5718703_1280.jpg' className='d-block mx-lg-auto img-fluid' width={700} height={500}></img>
                </div>
              )
              : (
                <div className='col-10 col-sm-8 col-lg-6'>
                  ...
                  <div className='col-12'>
                    ...
                    <p><Link to="/create" className='btn btn-secondary col-6 p-3'>I want to create a campaign</Link></p>
        ...
        <h1 className='display-5 fw-bold lh-1 mb-3' style={{ color: "#333", fontFamily: "Euclid Circular B, sans-serif" }}>Donate Crypto</h1>
          ...
          ?(
            ...
            <button type='button' className='btn btn-primary btn-lg px-4 me-md-2' onClick={btnLoginClick}>
              <img alt='Connect MetaMask' src='https://raw.githubusercontent.com/luiztools-cursos/web3-week-1/c61b777e37fc45667100e3d49ffa097940b21604/dapp/public/metamask.svg' width={64} className='me-3'></img>
